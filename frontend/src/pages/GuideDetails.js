          ...
          <div className="guide-details flex relative ">
            <div className="context-container">
              <div className="btn-container">
                <button onClick={this.backToListOfGuids} className="back-btn">
                  Back
                </button>
              </div>
              ...
              <div className="guide-rank">
                <Icon size={"small"} disabled name="star" />
                {this.props.guide.avgRank}
              ...
              <div className="lang-from-guide">
                <div className="from-guide">
                  <span className="guide-field-title">From: &nbsp;</span>
                  <span>{this.props.guide.city}</span> &nbsp;
                </div>
                <div className="guide-lang">
                  <span className="guide-field-title">Languages: &nbsp;</span>
                  {this.props.guide.langugages.map((langugage, index) => {
                    return this.props.guide.langugages.length - 1 > index ? (
                      <span>{langugage + " , "}</span>
                    ) : (
                      <span>{langugage}</span>
                    );
